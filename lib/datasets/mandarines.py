...
# Adaptation of pascal_voc for mandarines dataset
...
class mandarines(imdb):
    def __init__(self, image_set, data_path=None):
        imdb.__init__(self, 'mandarine_' + image_set)
    ...
    def _get_default_path(self):
        """
        Return the default path where mandarine is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'mandarines')
    ...
    def _get_voc_results_file_template(self):
        # VOCdevkit/results/mandarine/Main/<comp_id>_det_test_aeroplane.txt
