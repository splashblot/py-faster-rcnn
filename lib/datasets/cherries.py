...
# Adaptation of pascal_voc for cherries dataset
...
class cherries(imdb):
    ...
    def _get_default_path(self):
        """
        Return the default path where cherry is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'cherries')
    ...
    def _get_voc_results_file_template(self):
        # VOCdevkit/results/cherry/Main/<comp_id>_det_test_aeroplane.txt
